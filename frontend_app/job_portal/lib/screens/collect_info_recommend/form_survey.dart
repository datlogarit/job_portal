...
class CollectInfoRecommend extends StatelessWidget {
  CollectInfoRecommend({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final List<DropdownItem<String>> skills = [
      ...
      DropdownItem(
          label: 'Papaya Social Game Engine',
          value: 'Papaya Social Game Engine'),
      ...
      DropdownItem(
          label: 'Simple MVC Framework', value: 'Simple MVC Framework'),
      ...
      DropdownItem(
          label: 'Tiếng Anh thành thạo', value: 'Tiếng Anh thành thạo'),
      ...
      DropdownItem(
          ...
          value: 'Biên phiên dịch tiếng Hàn'),
      DropdownItem(
          label: 'Biên phiên dịch tiếng Anh',
          value: 'Biên phiên dịch tiếng Anh'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Kỹ năng quản lý công việc',
          value: 'Kỹ năng quản lý công việc'),
      ...
      DropdownItem(
          label: 'Xây dựng mối quan hệ', value: 'Xây dựng mối quan hệ'),
      ...
      DropdownItem(
          label: 'Khả năng thuyết phục', value: 'Khả năng thuyết phục'),
      DropdownItem(
      ...
      DropdownItem(
          label: '3D Seismic Interpretation',
          value: '3D Seismic Interpretation'),
      ...
      DropdownItem(
          label: 'JavaScript Libraries', value: 'JavaScript Libraries'),
      ...
      DropdownItem(
          label: 'Purchasing Processes', value: 'Purchasing Processes'),
      ...
      DropdownItem(
          label: 'Wholesale Purchasing', value: 'Wholesale Purchasing'),
      ...
      DropdownItem(
          label: 'Academic Development', value: 'Academic Development'),
    ...
    final List<DropdownItem<String>> sampleJobs = [
      ...
      DropdownItem(
          label: 'Call Center/Trực tổng đài',
          value: 'Call Center/Trực tổng đài'),
      ...
      DropdownItem(
          label: 'Sales Admin/Sales Support',
          value: 'Sales Admin/Sales Support'),
      DropdownItem(
          label: 'Sales Admin/Sales Support/Sales Associate',
          value: 'Sales Admin/Sales Support/Sales Associate'),
      DropdownItem(
          label: 'Chuyên viên đấu thầu', value: 'Chuyên viên đấu thầu'),
      ...
      DropdownItem(
          label: 'Bán hàng trang sức đá quý',
          value: 'Bán hàng trang sức đá quý'),
      DropdownItem(label: 'Bán hàng mỹ phẩm', value: 'Bán hàng mỹ phẩm'),
      DropdownItem(
          label: 'Kinh doanh thực phẩm', value: 'Kinh doanh thực phẩm'),
      ...
      DropdownItem(
          label: 'Bán hàng kỹ thuật IT', value: 'Bán hàng kỹ thuật IT'),
      ...
      DropdownItem(
          label: 'Kinh doanh khách sạn', value: 'Kinh doanh khách sạn'),
      ...
      DropdownItem(
          label: 'Kinh doanh triển lãm', value: 'Kinh doanh triển lãm'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Chuyên môn Marketing', value: 'Chuyên môn Marketing'),
      ...
      DropdownItem(
          label: 'Kiểm duyệt quảng cáo', value: 'Kiểm duyệt quảng cáo'),
      ...
      DropdownItem(
          ...
          value: 'Photographer/Video Editor'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Phát triển cộng đồng', value: 'Phát triển cộng đồng'),
      ...
      DropdownItem(
          label: 'Goverment Affairs Manager',
          value: 'Goverment Affairs Manager'),
      ...
      DropdownItem(
          label: 'Quantitative Analyst', value: 'Quantitative Analyst'),
      ...
      DropdownItem(
          label: 'Trưởng phòng nhân sự', value: 'Trưởng phòng nhân sự'),
      ...
      DropdownItem(
          label: 'Chuyên viên hợp đồng', value: 'Chuyên viên hợp đồng'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Mã hóa và bảo mật dữ liệu',
          value: 'Mã hóa và bảo mật dữ liệu'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Chuyên môn Tài chính', value: 'Chuyên môn Tài chính'),
      DropdownItem(
          label: 'Hoạch định tài chính', value: 'Hoạch định tài chính'),
      ...
      DropdownItem(
          label: 'Chuyên viên xử lý nợ', value: 'Chuyên viên xử lý nợ'),
      DropdownItem(
          label: 'Kinh doanh nguồn vốn', value: 'Kinh doanh nguồn vốn'),
      ...
      DropdownItem(
          label: 'Chuyên môn Ngân hàng khác',
          value: 'Chuyên môn Ngân hàng khác'),
      ...
      DropdownItem(
          label: 'Phòng chống rửa tiền', value: 'Phòng chống rửa tiền'),
      ...
      DropdownItem(
          label: 'Quản lý hợp đồng bảo hiểm',
          value: 'Quản lý hợp đồng bảo hiểm'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Chuyên viên kế hoạch', value: 'Chuyên viên kế hoạch'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Nhân viên môi trường', value: 'Nhân viên môi trường'),
      ...
      DropdownItem(
          label: 'Lắp đặt/bảo trì thang máy',
          value: 'Lắp đặt/bảo trì thang máy'),
      DropdownItem(
          label: 'Việc làm Bảo vệ/Bảo trì/Sửa chữa khác',
          value: 'Việc làm Bảo vệ/Bảo trì/Sửa chữa khác'),
      DropdownItem(
          label: 'Vệ sinh/Giúp việc/Bảo mẫu',
          value: 'Vệ sinh/Giúp việc/Bảo mẫu'),
      ...
      DropdownItem(
          label: 'Chăm sóc sức khoẻ/Làm đẹp',
          value: 'Chăm sóc sức khoẻ/Làm đẹp'),
      ...
      DropdownItem(
          label: 'Dịch vụ làm đẹp khác', value: 'Dịch vụ làm đẹp khác'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Thợ thủ công mỹ nghệ', value: 'Thợ thủ công mỹ nghệ'),
      ...
      DropdownItem(
          label: 'Kỹ sư cấp thoát nước', value: 'Kỹ sư cấp thoát nước'),
      ...
      DropdownItem(
          label: 'Kỹ sư hạ tầng đô thị', value: 'Kỹ sư hạ tầng đô thị'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Kế toán chi phí/giá thành',
          value: 'Kế toán chi phí/giá thành'),
      ...
      DropdownItem(
          label: 'Chuyên môn Kiểm toán khác',
          value: 'Chuyên môn Kiểm toán khác'),
      DropdownItem(label: 'Thuế', value: 'Thuế'),
      DropdownItem(label: 'Chuyên viên thuế', value: 'Chuyên viên thuế'),
      DropdownItem(
          label: 'Chuyên môn Thuế khác', value: 'Chuyên môn Thuế khác'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Giáo viên tiếng Nhật', value: 'Giáo viên tiếng Nhật'),
      ...
      DropdownItem(
          label: 'Giáo viên STEAM/STEM', value: 'Giáo viên STEAM/STEM'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Huấn luyện viên Yoga', value: 'Huấn luyện viên Yoga'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Trợ giảng tiếng Nhật', value: 'Trợ giảng tiếng Nhật'),
      ...
      DropdownItem(
          label: 'Giáo viên dạy lái xe ô tô',
          value: 'Giáo viên dạy lái xe ô tô'),
      ...
      DropdownItem(
          label: 'Giáo viên dạy nấu ăn', value: 'Giáo viên dạy nấu ăn'),
      ...
      DropdownItem(
          label: 'Thiết kế/chế tạo máy', value: 'Thiết kế/chế tạo máy'),
      ...
      DropdownItem(
          label: 'Hoá chất/Hoá mỹ phẩm', value: 'Hoá chất/Hoá mỹ phẩm'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Tài xế lái máy công trình',
          value: 'Tài xế lái máy công trình'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Quản lý thiết bị sản xuất',
          value: 'Quản lý thiết bị sản xuất'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Kỹ sư lập trình PLC/SCADA',
          value: 'Kỹ sư lập trình PLC/SCADA'),
      ...
      DropdownItem(
          label: 'Analog IC Design Engineer',
          value: 'Analog IC Design Engineer'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Kỹ sư kiểm thử viễn thông',
          value: 'Kỹ sư kiểm thử viễn thông'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Kỹ sư truyền dẫn cáp', value: 'Kỹ sư truyền dẫn cáp'),
      DropdownItem(
          label: 'Kỹ sư thiết bị viễn thông',
          value: 'Kỹ sư thiết bị viễn thông'),
      ...
      DropdownItem(
          label: 'Tài xế lái xe chuyên dụng',
          value: 'Tài xế lái xe chuyên dụng'),
      DropdownItem(
          label: 'Dịch vụ vận tải khác', value: 'Dịch vụ vận tải khác'),
      ...
      DropdownItem(
          label: 'Quản lý/Giám sát mua hàng',
          value: 'Quản lý/Giám sát mua hàng'),
      ...
      DropdownItem(
          label: 'Giám đốc Thu mua/Mua hàng',
          value: 'Giám đốc Thu mua/Mua hàng'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Chuyên môn chuỗi cung ứng',
          value: 'Chuyên môn chuỗi cung ứng'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Chuyên môn Logistics khác',
          value: 'Chuyên môn Logistics khác'),
      ...
      DropdownItem(
          label: 'Dịch vụ chăm sóc sức khoẻ',
          value: 'Dịch vụ chăm sóc sức khoẻ'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Dịch vụ bà mẹ trẻ em', value: 'Dịch vụ bà mẹ trẻ em'),
      DropdownItem(label: 'Chăm sóc mẹ và bé', value: 'Chăm sóc mẹ và bé'),
      DropdownItem(
          label: 'Dịch vụ bà mẹ trẻ em khác',
          value: 'Dịch vụ bà mẹ trẻ em khác'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Giám định bồi thường ô tô',
          value: 'Giám định bồi thường ô tô'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Tư vấn CNTT/IT consultant',
          value: 'Tư vấn CNTT/IT consultant'),
      ...
      DropdownItem(
          label: 'Chuyên gia thẩm rượu', value: 'Chuyên gia thẩm rượu'),
      ...
      DropdownItem(
          label: 'Dịch vụ đưa đón khác', value: 'Dịch vụ đưa đón khác'),
      ...
      DropdownItem(
          label: 'Nghề Biên phiên dịch', value: 'Nghề Biên phiên dịch'),
      DropdownItem(
          label: 'Biên phiên dịch tiếng Anh',
          value: 'Biên phiên dịch tiếng Anh'),
      DropdownItem(
      ...
      DropdownItem(
          ...
          value: 'Biên phiên dịch tiếng Nga'),
      DropdownItem(
          label: 'Biên phiên dịch tiếng Tây Ban Nha',
          value: 'Biên phiên dịch tiếng Tây Ban Nha'),
      DropdownItem(
          label: 'Biên phiên dịch tiếng Đức',
          value: 'Biên phiên dịch tiếng Đức'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Nghề Y tá/Điều dưỡng', value: 'Nghề Y tá/Điều dưỡng'),
      ...
      DropdownItem(
          label: 'Bác sĩ/Kỹ thuật viên', value: 'Bác sĩ/Kỹ thuật viên'),
      ...
      DropdownItem(
          label: 'Kỹ thuật viên gây mê', value: 'Kỹ thuật viên gây mê'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Kỹ sư Bioinformatics', value: 'Kỹ sư Bioinformatics'),
      ...
      DropdownItem(
          label: 'Quản lý dự án y dược', value: 'Quản lý dự án y dược'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Phát triển thuốc thử', value: 'Phát triển thuốc thử'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Thiết kế Công nghiệp', value: 'Thiết kế Công nghiệp'),
      DropdownItem(
      ...
      DropdownItem(
          label: 'Nghệ thuật/Hoạt hình/Game',
          value: 'Nghệ thuật/Hoạt hình/Game'),
      ...
      DropdownItem(
          label: 'Quản lý/Giám sát thiết kế',
          value: 'Quản lý/Giám sát thiết kế'),
      DropdownItem(
                        ...
                        chipDecoration: const ChipDecoration(
                            border: Border(
                                top: BorderSide(
                                    width: 1, color: Colors.redAccent))),
                        fieldDecoration: FieldDecoration(
                          hintText: 'Select the desired job',
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(12),
                          ),
                        ),
