...
class _JobDetailState extends State<JobDetail> {
  ...
  void getApplication() async {
    try {
      ...
      setState(() {
        if (applicationProvider.application.statusApply == 'not yet' ||
            applicationProvider.application.statusApply == null) {
          statusApply = applyButton();
        } else if (applicationProvider.application.statusApply == 'applied') {
          statusApply = applied();
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  TextIcons(
                      Icons.location_on_sharp, "${widget.job.workLocation}"),
                  widget.workTime
                      ? TextIcons(
                          Icons.timelapse,
                          Stringhelper.formatText(
