...
class _JobInteractionPageState extends State<JobInteractionPage> {
  ...
  void initState() {
    ...
    mergedIneractionProvider
        .getAllInteraction(userProvider.applicant.userId!.id!)
        .then((_) {
      setState(() {
  ...
  @override
  void didUpdateWidget(covariant JobInteractionPage oldWidget) {
    setState(() {
      selected = 0;
    });
    final userProvider = context.read<ApplicantProvider>();
                  ...
                  child: ListView.separated(
                      ...
                      itemBuilder: (context, index) => GestureDetector(
                            onTap: () async {
                              ...
                              //gửi thông tin ở đây
                              bool result = await widget.interactionRepo
                                  .updateRead(
